...
class cpMysql {
	...
	public function error($message = ''){
		...
		$str = '';
		if( DEBUG ){
			$str = "<br> <b style='color: #ff3f64;'>{$message}</b><br>
					<b style='color: #ff3f64;'>SQL</b>: {$this->sql}<br>
					<b style='color: #ff3f64;'>错误详情</b>: {$error}<br>
					<b style='color: #ff3f64;'>错误代码</b>:{$errorno}<br>";
		} else {
			$str = "<b style='color: #ff3f64;'>出错</b>: 【{$message}】<br>
					<b style='color: #ff3f64;'>SQL</b>: 【{$this->sql}】<br>
					<b style='color: #ff3f64;'>错误详情</b>: 【{$error}】<br>
					<b style='color: #ff3f64;'>错误代码</b>:【{$errorno}】<br>";
		}
