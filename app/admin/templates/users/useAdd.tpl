    ...
    <div class="panel-body">
        <form id="defaultForm" method="post" name="defaultForm" class="form-horizontal" action="?r=admin/users/useModify"   role="form" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <{if $user['username']|default:FALSE}>  <!--smarty-->
                        <input type="hidden" value="<{$user['id']}>" name="id" >
                        <input type="text" value="<{$user['username']}>" class="form-control" name="username" id="username" placeholder="用户名" />
                    <{else}>
            ...
            <div class="form-group"  >
                ...
                <div class="col-sm-9">
                    <{if isset($user['email']) }>
                        <input type="text" class="form-control" name="email" id="email" placeholder="邮箱" value="<{$user['email']}>"/>
                    <{else}>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="imageBox" style="background-image: url(<{if isset($user['protrait'])}><{$user['protrait']}><{else}> <{ROOT}><{#protrait#}><{/if}>); background-size: 400px 460px; background-position: 25px -9px; background-repeat: no-repeat;">
...
<script  type="text/javascript">
    ...
    var preview_src="<{if isset($user['protrait'])}><{$user['protrait']}><{else}> <{ROOT}><{#protrait#}><{/if}>";
